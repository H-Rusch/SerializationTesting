...
public class JsonMeasurement extends Measurement {
    ...
    public JsonMeasurement() {
        super("JSON", "json", "json");
        this.mapper = new ObjectMapper();
    }

    // constructor for BSON Measurement
    public JsonMeasurement(String name, String filename, String fileExtension, ObjectMapper mapper) {
    ...
    public Object deserializeObject1(byte[] bytes) throws IOException {
        return mapper.readValue(bytes, DataJson1.class);
    }
    ...
    public Object deserializeObject2(byte[] bytes) throws IOException {
        return mapper.readValue(bytes, DataJson2.class);
    }
